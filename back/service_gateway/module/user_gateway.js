 ...
 *          dataType: String
 *        - name: consumer_key
 *          description: Consumer key (headers.data)
 *          paramType: headers
 *          dataType: String
 *        - name: access_token_key
 *          description: Token accès (headers.data)
 *          paramType: headers
 *          dataType: String
 */
 ...
 * operations:
 *   -  httpMethod: POST
 *      summary: Vérifie si l'utilisateur est connecté à Steam et twitter et envoi un Tweet d'information sur le jeu en cours
 *      notes:  Vérifie si l'user est connecté a un jeux et envoi un tweet 
 *      nickname: roll
 *      consumes: 
 *        - text/html
 *      parameters:
